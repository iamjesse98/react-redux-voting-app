	...
	render() {
		return (
			<div>
				...
				<span className='label label-danger'>Vue: {this.votesVueInPercent().toFixed(2) + '%'}</span>
				<div className='progress progress-striped active'>
					<div className='progress-bar progress-bar-success' style={this.votesVueInPercentStyle()}></div>
				</div>
